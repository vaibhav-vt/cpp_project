...
void Game::init(const char* title,int xpos,int ypos,int width,int height, bool fullscreen)
{
    ...
    if(renderer)
    {
        // SDL_SetRenderDrawColor(renderer,191,255,115,0.77);
    ...
    Gameover = new Gameobject("gameover.jpeg",50,50,1,1,0);
    // rim = new Gameobject("rim.png",680,150,6,7,0);
    rim = new Gameobject("bowl.png",680+100,150+150,3,2,0);

    bush = new Gameobject("bush.png",940,530,1,1,0);
    //bush = new Gameobject("bush.png",765,240,1,1,0);
